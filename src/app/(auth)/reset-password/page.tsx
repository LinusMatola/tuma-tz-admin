...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // await apiPost("/account/reset-password", { email, newPassword });
      await new Promise((r) => setTimeout(r, 1000)); // simulate API call
      sessionStorage.removeItem("tuma_first_login_email");
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 xl:p-10">
          ...
          <p className="text-slate-500 text-sm mb-8">
            Choose a strong password for your account. You'll use this every
            time you log in.
          </p>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg bg-slate-100 border text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition pr-12 ${
