  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{ background: "linear-gradient(160deg, #1a3de4 0%, #0d1f7a 60%, #0a0f2e 100%)" }}
      >
        ...
        <div className="absolute -top-20 -right-20 w-72 h-72 rounded-full opacity-10"
          style={{ background: "radial-gradient(circle, #4d7af5, transparent)" }} />
        ...
        <div className="relative z-10">
          <p className="text-blue-200 text-sm leading-relaxed opacity-80 mb-8">
            ...
            Professional grade security for the next generation of African fintech.
          </p>
